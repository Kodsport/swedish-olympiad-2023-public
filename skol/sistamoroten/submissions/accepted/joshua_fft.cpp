// I can't be bothered to slim my template, since this is not a solution we test for. It's slower than m2n on all testcases due to larger FFT constant factor, but can handle n=m=1000
