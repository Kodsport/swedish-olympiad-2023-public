...
// Don't read this code. It was written with too much stress and too little sleep. Changed slightly over and over until gave AC
int32_t main()
{
    fast();
    ...
    vp2 obstacles(n);
    rep(i, n) read(obstacles[i].first), read(obstacles[i].second);
